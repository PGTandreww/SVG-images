...
//                break;
        ...
        if(frame_w > 0 && frame_h > 0 && ((addLsash && (lsash_w > 0 && lsash_h > 0)) || (addRsash && (rsash_w > 0 && rsash_h > 0)))){
            ...
            var addRgrid = false;
            var addFgrid = false;
            var rgrid_align, lgrid_align, fgrid_align;
            ...
            if(addFgrid){
                ...
                //align grids
                if(addLgrid && lgrid_align === fgrid_align){
                    alignlite_h("fglass_pane", "fgrid", "lglass_pane", "lgrid", "", 0);
                }
                if(addRgrid && rgrid_align === fgrid_align){
