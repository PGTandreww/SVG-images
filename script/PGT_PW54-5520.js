...
function generate(evt)
{
	...
	var color = getFrameColor(FRMCLR,"V");
	...
	var addFin = false;
        ...
        switch(FRMTYPE){
            case ".625FLANGE":
                ...
                frame_headWidth = 2.106;
                frame_headFin = 0;
                frame_headOffset = .622;
                frame_sillWidth = 2.106;
                frame_sillFin = 0;
                frame_sillOffset = 0.622;
                frame_leftWidth = 2.106;
                frame_leftFin = 0;
                frame_leftOffset = 0.622;
                frame_rightWidth = 2.106;
                frame_rightFin = 0;
                frame_rightOffset = 0.622;
                break;
            case "EQUAL":
                //base dims for flange frame...pulled from CAD drawing
                frame_headWidth = 1.484;
                frame_headFin = 0;
                frame_headOffset = 0;
                frame_sillWidth = 1.484;
                frame_sillFin = 0;
                frame_sillOffset = 0;
                frame_leftWidth = 1.484;
                frame_leftFin = 0;
                frame_leftOffset = 0;
                frame_rightWidth = 1.484;
                frame_rightFin = 0;
                frame_rightOffset = 0;
                break;
            case "1.375FIN":
	...
	//adjustDocSize(WDTH,HGHT,400,400,PAD);
        ...
        if(frame_w > 0 && frame_h > 0){
            ...
            if(addFin){
                initOuterMiterFrame("frame_fin", 0, 0, frame_w + frame_leftFin + frame_rightFin, frame_h + frame_headFin + frame_sillFin, frame_leftFin, frame_rightFin, frame_headFin, frame_sillFin, color);
            }

            initOuterMiterFrame("frame", frame_x, frame_y, frame_w, frame_h, frame_leftWidth,frame_rightWidth, frame_headWidth,frame_sillWidth, color);
...
//            var grid_color = getFrameColor(COLCLR,"V");
...
//            }
            ...
            initMitredFrame("bead", bead_x, bead_y, bead_w, bead_h, bead_partWidth, color);
            //Add dims
            var w_dimOffset = 1.5;
            var h_dimOffset = 1.5;
