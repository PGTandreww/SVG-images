        ...
        if(frame.width > 0 && frame.height> 0){
            ...
            switch(FRMTYPE){
                case ".625FLANGE":
                    ...
                    frame.headWidth = 3.283;
                    frame.headFin = 0;
                    frame.headOffset = 0.625;
                    frame.sillWidth = 3.283;
                    frame.sillFin = 0;
                    frame.sillOffset = 0.625;
                    frame.leftWidth = 3.283;
                    frame.leftFin = 0;
                    frame.leftOffset = 0.625;
                    frame.rightWidth = 3.283;
                    frame.rightFin = 0;
                    frame.rightOffset = 0.625;
                    break;
                case "EQUAL":
                    //base dims for flange frame...pulled from CAD drawing
                    frame.headWidth = 2.658;
                    frame.headFin = 0;
                    frame.headOffset = 0;
                    frame.sillWidth = 2.658;
                    frame.sillFin = 0;
                    frame.sillOffset = 0;
                    frame.leftWidth = 2.658;
                    frame.leftFin = 0;
                    frame.leftOffset = 0;
                    frame.rightWidth = 2.658;
                    frame.rightFin = 0;
                    frame.rightOffset = 0;
                    break;
                case "1.375FIN":
...
//            }
            ...
            bead.width = frame.width - frame.leftWidth - frame.rightWidth;
            ...
            trace("InitGlass");
            initGlass("glass","frame", glass.x, glass.y, glass.width, glass.height, 0, glass.color);
            ...
            with (grid){
                if (bar_width > 0){
                    ...
                    if(location2 > 0){
                        location2 = frame.height - location2;
                    }
...
//            }
            ...
            initMitredFrame("frame_indent", frame.x + frame.leftOffset + .5841, frame.y + frame.headOffset + .5841, frame.width - (frame.leftOffset + frame.rightOffset) - (.5841*2), frame.height - (frame.headOffset + frame.sillOffset) - (0.5841*2), 0.2245, adjustColor(frame.color, -20));
