...
if(grid == "")
	...
	if(gls_flag == 2)
	{
		initGlassTriangle("glass","frame",0, 0, width,height,(frame_t-adj_gls_w), adj_gls_w, "IT");
	}
	if(grid != "NONE")
	{
	...
	if(fr_flag == 2)
	{
		initMitredTriangleFrame("frame", 0, 0, width, height, frame_t, color, "IT");
	}

	if(fr_flag == 2  && f_nested != "true")  //Dimension section
	{
