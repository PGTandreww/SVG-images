...
var segType = segParm === null ? "F":segParm;
	...
	else
	{
		...
		{
			case 'F':
				computeCircleCenter(x,y+h-h2,x+w/2,y,x+w,y+h-h2); // sets global R
				pLT = new Point(x,y+h-h2);
				pRT = new Point(x+w,y+h-h2);
				pLB = new Point(x,y+h-sill);
				pRB = new Point(x+w,y+h-sill);
				break;

			case 'L':
				computeCircleCenter(x,y+h-h2,x+w,y,x+(2*w),y+h-h2); // sets global R
				pLT = new Point(x,y+h-h2);
				pRT = new Point(x+w,y);
				pLB = new Point(x,y+h-sill);
				pRB = new Point(x+w,y+h-sill);
			...
			case 'R':
				computeCircleCenter(x-w,y+h-h2,x,y,x+w,y+h-h2); // sets global R
				pLT = new Point(x,y);
				pRT = new Point(x+w,y+h-h2);
				pLB = new Point(x,y+h-sill);
				pRB = new Point(x+w,y+h-sill);
	...
	if(hLegs === 0)
	{
		switch(segType)
		{
			...
			case "L":
				iLT = new Point( pC.x - Math.sqrt(Math.pow(rInner,2)-Math.pow(pC.y-pLT.y,2)),
								pLT.y);
				iRT = new Point( pRT.x - inset,pC.y - Math.sqrt(Math.pow(rInner,2)-Math.pow(inset,2)));
