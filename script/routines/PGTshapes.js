...
trace("initTrapezoidFrame('"+id+"',"+x+","+ y+","+ w+","+ h+","+hs+","+ f+","+sillThk+",'"+ color+"','"+ type+"')");
	...
	var angleA, angleB, angleC, degA, degB, degC, pointA, pointB, pointC, pointD, pathA, pathB, pathC, pathD, insetX, insetY;
...
trace("initHomePlateFrame('"+id+"',"+x+","+ y+","+ w+","+ h+","+hs+","+ f+","+sillThk+",'"+ color+"','"+ type+"')");
	...
	var angleA,angleB,angleC,angleE,degA,degB,degC,degE, pointA, pointB, pointC, pointD, pointE, pathA, pathB, pathC, pathD, pathE, insetX, insetY;
	...
	switch(type)
	{
		case "T":  // pointy end up
		{
			...
			trace("insetY: "+insetY);
			pointA = new Point(x+(w/2),y+insetY);
			trace("pointA: "+pointA.x+", "+pointA.y);
			...
			pointB = new Point(x+w-f,y+(h-hs)+insetY);
			trace("pointB: "+pointB.x+", "+pointB.y);
			pointE = new Point(x+f,y+(h-hs)+insetY);
			trace("pointE: "+pointE.x+", "+pointE.y);
				
			
			pointC = new Point(x+w-f,y+h-sillThk);
			trace("pointC: "+pointC.x+", "+pointC.y);
			
			pointD = new Point(x+f,y+h-sillThk);
			trace("pointD: "+pointD.x+", "+pointD.y);
 ...
 * @param w			decimal width 
 * @param h			decimal height of long side
 * @param hl		decimal height of left side
 * @param hr		decimal height of right side
 * @param p		decimal peak from left side
 * @param f			decimal frame thickness
 * @param sillThk	decimal sill thickness
 * @param color		String web color code
 * @return
 */
function initHomePlateFrameNEW(id, x, y, w, h, hl, hr, p, f,sillThk, color)
{
try
{
trace("initHomePlateFrame('"+id+"',"+x+","+ y+","+ w+","+ h+","+hl+","+hr+","+p+","+ f+","+sillThk+",'"+ color+"')");
	...
	var angleA,angleB,angleC,angleE,degA,degB,degC,degE, pointA, pointB, pointC, pointD, pointE, pathA, pathB, pathC, pathD, pathE, insetX, insetY;
        ...
        angleA = Math.atan2(w-p,(h-hr));

        insetY = Math.sqrt(Math.pow(f/Math.tan(angleA),2)+Math.pow(f,2));
        pointA = new Point(x+p,y+insetY);
        ...
        pointB = new Point(x+w-f,y+(h-hr)+insetY);
        pointE = new Point(x+f,y+(h-hl)+insetY);
