 ...
 * @param orientation	H (full top/bottom) or V (full sides)
 * @return
 */
 
function initShutterFrame(id, x, y, w, h, f,fTop,fBot, color, orientation)
{
try
{
trace("initShutterFrame('"+id+"',"+x+","+ y+","+ w+","+ h+","+ f+","+fTop+","+ fBot+",'"+ color+",'"+ orientation+"')");
